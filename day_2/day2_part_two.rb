...
input_file.each_line do | line |
  # Using regular expression, get the min and max and password character, adjusting for a zero-index
  ...
  # Check to see if the policy exists exactly once in the password position
